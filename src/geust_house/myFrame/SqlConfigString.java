...
public class SqlConfigString {
    ...
    final static String SELECT_ROOMPRICE="select price from room JOIN roomtype on room_type_id=type_id join room_price on roomtype.type_id=room_price.room_type_id where room_id=? and typeof_living_id=?";
     ...
     final static String GET_CUSID_TO_INSERT_INTO_INVOICE="select c.cus_id from customer c join check_in ch on c.cus_id=ch.cus_id join check_in_detail cd on ch.check_in_id=cd.check_in_id where room_id=?;";
     ...
     final static String GET_CUNAME_INSERTINTO_CHECKOUT="select c.cus_name,cd.check_in_date,cd.check_in_id,c.cus_id from customer c join check_in ch "
     ...
     final static String GET_CHECKIN_ID_AND_ROOMID_FOR_CHANGE_ROOM="SELECT c.check_in_id,c.cus_id,cd.check_in_date,cd.Adult,cd.Children,cd.pay\n" +
     ...
     //final static String SELECT_BOOK_PRICE= "select book_detail.book_price from book_detail join book on book_detail.book_id=book.book_id where book.book_id=?;";
     final static String INSERT_INTO_CHANGE_ROOM="insert into changeroom(changeroom_date,old_check_in_id,old_room_id,staff_id,cus_id) values(?,?,?,?,?)";
    ...
    final static String SELECT_CHECKOUTDATE="SELECT checkOut_date from checkout where checkIn_id=?;";
    final static String SELECT_BOOK_PRICE_OF_AROOM="select book_price from book_detail where ROOM_ID=? and status='Booking'";
    final static String SELECT_DATE_OF_BOOKING="select book_chekIn_date,book_checkOut_date,cus_id from book where book_id=?";
